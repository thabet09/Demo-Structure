...
public class ListeDossiersPage {
    ...
    private By CheckBox = By.xpath("/html/body/app-root/app-main/div/div/div/div/div/app-dossier-list/div/div[2]/div/table/tbody/tr[1]/td[2]");
    ...
    private By AjouterButton = By.xpath("//button[text()=' + Ajouter ']");
    ...
    public FicheClientPage ClickAjouterButton() throws InterruptedException{
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.visibilityOfElementLocated(AjouterButton));
        driver.findElement(AjouterButton).click();
        WebDriverWait wait2 = new WebDriverWait(driver, Duration.ofSeconds(20));
        wait2.until(ExpectedConditions.visibilityOfElementLocated(By.id("nomJeuneFilleEmp")));
